  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-950 dark:bg-[#050505] dark:text-zinc-100">
      ...
      <main className="mx-auto flex min-h-[calc(100vh-72px)] max-w-6xl flex-col gap-20 px-6 py-10 sm:px-8">
        <section className="flex flex-col justify-center gap-8 py-12 sm:py-16">
          <div className="space-y-4">
            <p className="text-sm font-semibold uppercase tracking-[0.3em] text-zinc-500 dark:text-zinc-400">
              Personal Portfolio
            </p>
            <h1 className="max-w-3xl text-4xl font-semibold leading-snug sm:text-5xl">
              Hi, I’m Harshil. I build clean web experiences with Next.js and modern design.
            </h1>
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <a
              ...
              className="inline-flex w-full items-center justify-center rounded-full bg-black px-5 py-3 text-sm font-semibold text-white transition hover:bg-zinc-800 dark:bg-white dark:text-black dark:hover:bg-zinc-200 sm:w-auto"
              target="_blank"
              rel="noreferrer"
            >
              LinkedIn
        ...
        <section id="about" className="space-y-6 rounded-3xl border border-black/10 bg-white/90 p-8 shadow-lg shadow-black/5 dark:border-white/10 dark:bg-white/5 dark:shadow-white/5">
          <div className="space-y-3">
            <p className="text-sm uppercase tracking-[0.3em] text-zinc-500 dark:text-zinc-400">About me</p>
            <h2 className="text-2xl font-semibold">A small, intentional portfolio.</h2>
          </div>
          <p className="max-w-3xl text-base leading-7 text-zinc-600 dark:text-zinc-300">
            I enjoy turning ideas into simple and engaging websites. I focus on clarity, performance, and thoughtful interactions while keeping the design minimal and memorable.
          </p>
        </section>
